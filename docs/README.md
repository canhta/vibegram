...
This directory is the source of truth for the first public version of `vibegram`.
...
4. [Telegram Model](./telegram-model.md)
5. [Provider Model](./provider-model.md)
6. [Event Model](./event-model.md)
...
- [Decision Memory Template](./templates/decision-memory-template.md)
- [Normalized Event Schema](./schemas/normalized-event.schema.json)
- [Role Result Schema](./schemas/role-result.schema.json)
